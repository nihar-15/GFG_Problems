<h2><a href="https://www.geeksforgeeks.org/problems/k-largest-elements4206/1?page=2&difficulty=Medium&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">k largest elements</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr</strong> of <strong>n</strong> positive integers and an integer <strong>k</strong>, Your task is to return <strong>k largest elements </strong>in decreasing order.&nbsp;</span></p>
